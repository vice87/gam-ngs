...
RelativeStrandEvidencesGraph::RelativeStrandEvidencesGraph(const std::vector<Block>& blocks) :
...
void
RelativeStrandEvidencesGraph::addEdgeWeights(const std::vector<Block>& blocks)
{
    RelativeStrandEvidences evidences;
    
    std::vector<Block>::const_iterator b;
